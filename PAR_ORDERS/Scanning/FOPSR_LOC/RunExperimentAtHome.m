...
switch type
    ...
    case 'LOC'
        ...
        p.SCREEN.TEXT_COLOUR = [255 255 255];
        p.FIXATION.LEFT_VIEW.ADJUST_X = 0;
        p.FIXATION.LEFT_VIEW.ADJUST_Y = 100;
        p.FIXATION.RIGHT_VIEW.ADJUST_X = 0;
        p.FIXATION.RIGHT_VIEW.ADJUST_Y = 100;
        p.IMAGES.VERTICAL_SHIFT = 200; %number of PIXELS, positive is down, negative is up
        p.IMAGES.RESIZE_FACTOR = 1.2; %loaded images are scaled by this value, also adjusts EXPECTED_WIDTH/EXPECTED_HEIGHT, 1.1=10% larger
...
% %screen localizer
% p.SCREEN.NUMBER = 0;
% p.SCREEN.RECT = [1500 50 3420 1130]; %[0 0 1920 1080];
% p.SCREEN.EXPECTED_SIZE = [1080 1920]; %[height width]
...
%image
p.IMAGES.EXPECTED_WIDTH = 1280;
p.IMAGES.EXPECTED_HEIGHT = 1280;
