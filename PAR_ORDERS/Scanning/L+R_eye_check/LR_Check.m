function LR_Check(type,par, run)
...
p.KEY.BUTTON_BOX_GOOD = KbName({'r' '1!'}); %ED
p.KEY.BUTTON_BOX_BAD = KbName({'g' '2@'}); %ED
...
%print the correct order participant should report seeing the letters
fprintf('First correct answer is M. \n Second correct answer is F. \n');
%% Prepare
