...
switch type
    case 'PILOT'
        ...
        p.IMAGES.VERTICAL_SHIFT = -65; %number of PIXELS, positive is down, negative is up
        p.IMAGES.RESIZE_FACTOR = 1.3; %loaded images are scaled by this value, also adjusts EXPECTED_WIDTH/EXPECTED_HEIGHT, 1.1=10% larger
